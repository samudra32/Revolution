...
body>#login form {
    ...
    -moz-box-sizing: border-box;
    -wekbit-box-sizing: border-box;
    border: 4px solid #182cbe;
        /*border: 8px solid #4bbe18;*/
    display: inline-block;
    margin: 27px auto 0;
...
body>#login form button {
    ...
    background-color: #519334;#f6f6f6;
    cursor: pointer;
    margin-left: 12px;
    height: 56px;
    padding: 5px;
...
body>#login form button:hover { background-color: #da36c6;#f8f8f8 }
...
body>#login form button .button_text {
    ...
    background-repeat: repeat-x;
    background-image: linear-gradient(top, #fafafa, #da36c6;#f0f0f0);
    background-image: -khtml-gradient(linear, left top, left bottom, from(#fafafa), to(#f0f0f0));
    background-image: -moz-linear-gradient(top, #fafafa, #da36c6;#f0f0f0);
    background-image: -ms-linear-gradient(top, #fafafa,#da36c6; #f0f0f0);
    background-image: -o-linear-gradient(top, #fafafa, #da36c6;#f0f0f0);
